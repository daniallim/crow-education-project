...
<head>
    ...
    <title>Crow Education - Private Chat</title>
                ...
                <div class="chat-list" id="chatList">
                    <div class="chat-item active" data-chat-id="1">
                        ...
                        <div class="chat-info">
                            ...
                            <div class="chat-preview">Hey, are you working on the math assignment?</div>
            ...
            <div class="chat-main" id="chatMain">
                ...
                <div class="chat-messages">
                    <div class="message received">
                        <div class="message-text">Hey, are you working on the math assignment?
                        </div>
                        <div class="message-time">Sarah • 10:15 AM</div>
                    </div>
                    <div class="message sent">
                        <div class="message-text">Yes, I'm stuck on problem 3. It's tricky!
                        </div>
