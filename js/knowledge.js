...
function initializeThemeSystem() {
    ...
    if (savedAutoTheme === 'true' && autoThemeSection) {
        ...
        function initializeFloatingElements() {
            ...
            for (let i = 0; i < 5; i++) {
                createFloatingElement(floatingElementsContainer);
            }
        }
        ...
        function downloadFile(fileName) {
            showNotification(`Download feature for ${fileName} would work in production`);
        }

        function startCourse(courseName) {
            showNotification(`Starting course: ${courseName}`);
        }
